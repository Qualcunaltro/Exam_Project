...
def simulate_static(N, T, approximation):
...
def start_program(N, T, approximation, time_constant, anim_check):
	...
	if anim_check == True:
		...
		simulate_static(N, T, approximation)
		print("Animated Graph")

if __name__ == '__main__':
	p1, p2, p3, p4, p5 = setup()
	start_program(p1, p2, p3, p4, p5)
